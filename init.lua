...
minetest.register_on_joinplayer(function(player)
    if player:get_hp() > 0 then
        ...
        local formspec = "size[17,10]"
         ...
         -- 🔗 BOTÓN PÁGINA WEB
         .. "button_url[12.6,1.2;3.8,0.9;web_link;Visit Website;https://just-craft.servehttp.com/]"
         ---boton Foro 
        ...
        --------------------------------------------------
        formspec = formspec ..
            "label[0.0,8.3;General Section: Enjoy the server!]"
...
-- Cargar AC panel
--------------------------------------------------
local ac_file = minetest.get_modpath("welcome") .. "/ac.lua"
dofile(ac_file)

--------------------------------------------------
-- Cargar IF panel
--------------------------------------------------
local if_file = minetest.get_modpath("welcome") .. "/if.lua"
dofile(if_file)

dofile(minetest.get_modpath("welcome") .. "/help.lua")
dofile(minetest.get_modpath("welcome") .. "/a.lua")